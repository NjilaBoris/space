    ...
    <>
      <div className="preloader" ref={preloaderRef}>
        ...
        <div className="preloader-images">
          <div className="img">
            <Image src="/images/img1.jpg" alt="" width={300} height={300} />
          </div>
          <div className="img">
            <Image src="/images/img2.jpg" alt="" width={300} height={300} />
          </div>
          <div className="img">
            <Image src="/images/img3.jpg" alt="" width={300} height={300} />
          </div>
          <div className="img">
            <Image src="/images/img4.jpg" alt="" width={300} height={300} />
          </div>
        </div>
      </div>

      <div className="preloader-header">
        <h1>Paris by Emily</h1>
      </div>
    </>
  );
};
